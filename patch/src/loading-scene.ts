...
export class LoadingScene extends SceneBase {
  ...
  preload() {
    ...
    // Standalone Android builds must not download runtime code from the network.
    // rextexteditplugin was only registered here and has no references elsewhere in
    // the current source tree, so the remote loader is intentionally omitted.
