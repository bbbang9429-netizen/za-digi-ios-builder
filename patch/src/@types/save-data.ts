...
export interface StarterAttributes {
  ...
  /** Offline custom starter editor: force an arbitrary active ability for this starter. */
  customAbility?: AbilityId | undefined;
  /** Offline custom starter editor: force an arbitrary passive ability for this starter. */
  customPassive?: AbilityId | undefined;
  /** Offline custom starter editor: up to four arbitrary moves exposed as custom egg moves. */
  customEggMoves?: MoveId[] | undefined;
}
...
export interface Starter {
  ...
  ivs: number[];
  /** Per-run custom active ability selected in the offline starter editor. */
  customAbility?: AbilityId | undefined;
  /** Per-run custom passive ability selected in the offline starter editor. */
  customPassive?: AbilityId | undefined;
  /** Per-run marker/data for arbitrary custom egg moves selected in the offline starter editor. */
  customEggMoves?: MoveId[] | undefined;
}
